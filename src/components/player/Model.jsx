...
import { Euler, Quaternion, Raycaster, Vector3, DoubleSide } from 'three'
            ...
            <group position={[0, 0, 0]}>
                <group ref={refC} dispose={null}>
                    ...
                    <group name="Scene" position={[0, 0, 0]}>
                        <group name="Armature" rotation={[Math.PI / 2, 0, -3.088]} scale={0.01}>
                            <skinnedMesh
                                name="Boy01_Body_Geo"
                        ...
                        <group position={[0.3, 0, -1]} ref={positionRef}>
